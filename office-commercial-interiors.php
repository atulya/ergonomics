...
<html lang="en">
  <head>
    <title>ERGONOMICS | Office &amp; Commercial Interiors</title>
    <meta charset="utf-8">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-offset-2 col-md-8 col-sm-12">
            <h2 class="wow fadeInUp" data-wow-delay="0.5s">Office &amp; Commercial Interiors </h2>
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        <div class="row">
          <div id="tabs-container">
            <ul class="tabs-menu">
              <li class="current"><a href="#tab-1">Modular Furniture</a></li>
