...
<?php include "menu.php" ?>
    ...
    <div class="container content">
      ...
      <div class="row">
        ...
        <h3>Reach Us</h3>
        <p>
          <strong>Address :</strong><br> A-306, Kanchanban Society, Shivtirtha Nagar, Paud Road, Kothrud, Pune - 411038.
        </p>
        <p>
        ...
        <form action="" class="col-md-8">
          ...
          <input type="text" required="required" placeholder="Name"  class="form-control" >
          <label for="">Contact No.</label>
          <input type="number" required="required" placeholder="Contact No."  class="form-control" >
