    ...
    <div class="container content">
      ...
      <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
          <h2>
            Interiors products, services for Office Commercial, Industrial &amp; Residential Primises
          </h2>
          ...
          <p>
            We are team of professionals and experience people in industrial and commercial Interiors field, who are collectively offering the free consultancy to connect the clients with rite products and services in the industry.  We are networked with multiple quality products and services in the interior Industry. This platform is just not for the networking of clients and products, but also to help out the clients to reach the quality product and services at optimum price.
          </p>
          <hr>
          <h3>Our Role</h3>
          <p>
          ...
          <p>
            ...
            <ul>
              ...
              <li>
                Establishing the long term client <img src="img/arrows.png" alt="">product, company, services relationship by offering you the best possible solutions till the completion of job.
              </li>
            </ul>
          </p>
          <hr>
